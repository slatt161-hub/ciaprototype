...
<button id="theme-toggle" aria-label="Toggle Dark Mode" class="p-2 rounded-full hover:bg-surface-variant transition-colors flex items-center justify-center text-[#811026] dark:text-[#fecb32] mr-2 md:mr-0">
